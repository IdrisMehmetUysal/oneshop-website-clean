...
export default function HuaweiReparatur() {
  ...
  return (
    <main className="min-h-screen text-green-900 bg-white">
      <Helmet>
        <title>
          Huawei Reparatur St. Pölten | Display, Akku & Software Hilfe | One 1
          Shop
        </title>
        <meta
          name="description"
      ...
      <section className="py-20 px-6 bg-green-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              <h3 className="font-semibold text-xl mb-3">App Probleme</h3>
              <p className="text-green-700">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              <h3 className="font-semibold text-xl mb-3">Akku Probleme</h3>
              <p className="text-green-700">
      ...
      <section className="py-20 px-6 bg-white text-center">
        <h2 className="text-3xl font-bold mb-6">Warum One 1 Shop?</h2>
